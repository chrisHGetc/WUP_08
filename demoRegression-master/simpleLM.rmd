...
summary.lm(myweight)
```
Residual standard error is 5.432 when comparing the length and weight. The adjusted R- squared is .7423.   
...
```
The comparison of the lenght and head length residuals standard error is 4.235 and the adjusted R-squared is .8434. 
